package com.raghava.collections.comparable.Sorting;
...
public class CollectionsComparable {
	...
	public static void main(String[] args)
	{
	    ...
	    // we are sorting watch object so we have to give our own implementation for compareTo to 
	    //make its comparable
	...
	int n=	Collections.binarySearch(arrayList, watch3);
